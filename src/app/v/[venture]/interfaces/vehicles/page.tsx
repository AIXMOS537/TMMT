          ...
          <>
            ...
            {vehicleMaintenance.length > 0 && (
              <DetailSection title="Recent Maintenance">
                ...
                <a href={ventureHref(ventureSlug, "/maintenance")} className="mt-1 inline-block text-xs text-blue-600 hover:text-blue-700 dark:text-blue-400">View all maintenance →</a>
              </DetailSection>
            )}
