        ...
        {selected && !editing && (
          <>
            ...
            <DetailSection title="Customer">
              <DetailRow label="Name" value={String(selected.customer_name ?? "—")} href={ventureHref(ventureSlug, "/customers")} />
              <DetailRow label="Phone" value={String(selected.phone ?? "—")} />
            </DetailSection>
            <DetailSection title="Related">
              <DetailRow label="Vehicle" value={String(selected.vehicle ?? selected.vehicle_name ?? "—")} href={ventureHref(ventureSlug, "/interfaces/vehicles")} />
              <DetailRow label="Contract" value={String(selected.contract ?? "—")} href={ventureHref(ventureSlug, "/interfaces/contracts")} />
            </DetailSection>
